...
(function () {
  ...
  // ============================================================
  // PROJECTS — Baca daftar project dari /projects.json
  // ============================================================

  let _cachedProjects = null;

  /**
   * getCategories() — Mengambil daftar project dari /projects.json
   * Hasil di-cache setelah fetch pertama.
  ...
  // ============================================================
  // TESTIMONI — Fetch & render dari GitHub
  // ============================================================
  ...
  async function renderTestimonials(targetId = "testi-scroll-container") {
    ...
    container.innerHTML = `<div style="padding:16px;color:var(--dim);font-size:13px;">Memuat testimoni...</div>`;
    ...
    try {
      ...
      if (!images.length) {
        container.innerHTML = `<div style="padding:16px;color:var(--dim);font-size:13px;">Testimoni tersedia melalui Discord resmi.</div>`;
        return;
      }
      ...
      container.innerHTML = `<div style="padding:16px;color:var(--dim);font-size:13px;">Gagal memuat testimoni.</div>`;
    }
  }
